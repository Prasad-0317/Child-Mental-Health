...
col1, col2, col3 = st.columns(3)
with col1:
    st.image(preprocess_image("img1.jpg"), caption="Image 1", use_container_width=True)
with col2:
    st.image(preprocess_image("img2.png"), caption="Image 2", use_container_width=True)
with col3:
    st.image(preprocess_image("img3.png"), caption="Image 3", use_container_width=True)
